...
public class PlayerControl : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        this.rocket_model =
            GameObject.Find("rocket").transform.Find("rocket_model").gameObject;
                ...
                case STEP.MOVE:
                    do
                    {
                        ...
                        if (this.closest_event != null)
                        {
                            ...
                            {
                                case _Event.TYPE.ROCKET: //이벤트의 종류가 ROCKET이면.
                                    //REPAIRING(수리) 상태로 이행.
            ...
            switch (this.step)
            {
                ...
                case STEP.REPAIRING: // '수리 중'이 되면.
                    if (this.carried_item != null)
                    {
                        ...
                        this.game_status.addRepairment(this.item_root.getGameRepairment(this.carried_item));
    ...
    private void pick_or_drop_control()
    {
        do
        {
                 ...
                 //들고 있는 아이템을 약간(1.0f) 앞으로 이동시켜서
            {
                ...
                this.carried_item = null; //들고 있던 아이템 없애기
            }
